        ...
        <form class="layui-form layui-col-md12 x-so" action="{{ url('admin/user') }}" method="get">
          ...
          <div class="layui-input-inline">
            <select name="num"  lay-filter="aihao">
              <option value="0" disabled selected hidden>每页显示</option>
          ...
          <input type="text" name="email" value="{{ $request->input('email') }}"  placeholder="请输入搜索邮箱" autocomplete="off" class="layui-input">
          <input type="text" name="phone" value="{{ $request->input('phone') }}" placeholder="请输入电话号码" autocomplete="off" class="layui-input">
